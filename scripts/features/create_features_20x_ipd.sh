...
# Run the appropriate Python script based on the backbone
if [[ "$backbone" == "virchow" ]]; then
    python extract_features_fp_virchow.py --data_h5_dir /N/project/histopath/patches/tcga_${organ}_20x_${mag} \
    --data_slide_dir /N/slate/sinnani/clam/tcga_${organ}_20x_wsi --csv_path dataset_csv/${organ}/tcga_${organ}_20x.csv \
    ...
    python extract_features_fp_hibou.py --data_h5_dir /N/project/histopath/patches/tcga_${organ}_20x_${mag} \
    --data_slide_dir /N/slate/sinnani/clam/tcga_${organ}_20x_wsi --csv_path dataset_csv/${organ}/tcga_${organ}_20x.csv \
    --feat_dir /N/project/histopath/tcga_${organ}_features/features_${backbone}/tcga_${organ}_${mag} --batch_size ${bs} \
    --slide_ext .svs --target_patch_size 224 --model_name ${backbone}
else
    python extract_features_fp.py --data_h5_dir /N/project/histopath/patches/tcga_${organ}_20x_${mag} \
    --data_slide_dir /N/slate/sinnani/clam/tcga_${organ}_20x_wsi --csv_path dataset_csv/${organ}/tcga_${organ}_20x.csv \
    --feat_dir /N/project/histopath/tcga_${organ}_features/features_${backbone}/tcga_${organ}_${mag} --batch_size ${bs} \
    --slide_ext .svs --target_patch_size 224 --model_name ${backbone}
fi