...
label=$2
model=$3
# mags=("20x" "10x" "5x" "2.5x" "20x_1" "10x_1" "5x_1" "2.5x_1")
mags=("20x" "5x" "20x_1" "5x_1")
# mags=("2.5x")
...
# python eval_miccai.py --k 10 --models_exp_code tcga_histology/virchow/wikgmil/2.5x_s1 --save_exp_code ebrains_histology_virchow_wikgmil_2.5x --task tcga_3_class --model_type wikgmil --results_dir results --data_root_dir /N/u/sinnani/BigRed200/MambaMIL/ --split test --features_dir /N/project/histopath/tcga_gbm_lgg_features/features_virchow/ebrains_2.5x/ --csv_path dataset_csv/ebrain_df_label_histology.csv --splits_dir splits/ebrain_who_2021_100/
